...
import PlcAciklama from "../../components/PlcAciklama";
  ...
  useEffect(() => {
    const getData = async () => {
      try {
        ...
        const PlcGet = data.find(
          (plc) => plc.titleParams === titleParams
        );
        setPlcState(PlcGet);
      } catch (error) {
        console.log(error);
  ...
  return (
    ...
    <div className="">
      <ul className="container  mx-auto flex items-center  sm:gap-x-5 gap-x-2 sm:text-sm text-xs sm:p-10 p-3  border-b border-gray-400">
        ...
        <li>
          <a href="">{plcState && plcState.title}</a>
        </li>
      </ul>
                ...
                <ul className="flex flex-col gap-y-7 font-extralight text-sm">
                  <li className="flex items-center gap-x-10 border-b pb-4">
                    ...
                    <div className="flex items-center gap-x-2">
                      <span>{plcState && plcState.DersSaati}</span>
                    </div>
                  </li>
                  <li className="flex items-center gap-x-10 border-b pb-4">
                    <div className="flex items-center gap-x-2  w-40">
                    ...
                    <div className="flex items-center gap-x-2">
                      <span>{plcState && plcState.KursSuresi}</span>
                    </div>
                  </li>
