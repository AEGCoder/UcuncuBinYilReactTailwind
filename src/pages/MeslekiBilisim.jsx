  ...
  return (
    <div className="w-full pt-10">
      <div className="relative">
        <video
          src="./videos/MeslekiBilisimVideo.mp4"
      ...
      <div>
        <ul className="flex items-center sm:gap-x-5 gap-x-1  sm:text-sm text-xs sm:p-10 p-3 border-b border-gray-400">
          <li>
            <a href="">Anasayfa</a>
          </li>
          <li>
          ...
          <li>
            <a href="">MESLEKİ BİLİŞİM  Eğitimleri</a>
          </li>
        </ul>
      </div>
          ...
          <>
            <ul className="grid sm:grid-cols-3 grid-cols-1 gap-y-10 pl-8 sm:pl-0">
              {currentItems.map((kurs) => (
                <Link key={kurs.id} to={`/meslekiBilisim/${kurs.titleParams}`}>
                <li key={kurs.id}>
