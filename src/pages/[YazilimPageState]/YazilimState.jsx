...
import YazilimAciklama from "../../components/YazilimAciklama";
...
const YazilimState = () => {
  ...
  const [yazilimData, setYazilimData] = useState([]);
  ...
  useEffect(() => {
    const getData = async () => {
      try {
        ...
        const YazilimGet = data.find(
          (yazilim) => yazilim.titleParams === titleParams
        );
        setYazilimData(YazilimGet);
      } catch (error) {
        console.log(error);
      }
    };
  ...
  return (
    ...
    <div className="">
      <ul className="container  mx-auto flex items-center  sm:gap-x-5 gap-x-2 sm:text-sm text-xs sm:p-10 p-3  border-b border-gray-400">
        ...
        <li>
          <a href="">{yazilimData && yazilimData.title}</a>
        </li>
      </ul>
                ...
                <ul className="flex flex-col gap-y-7 font-extralight text-sm">
                  <li className="flex items-center gap-x-10 border-b pb-4">
                    ...
                    <div className="flex items-center gap-x-2">
                      <span>{yazilimData && yazilimData.DersSaati}</span>
                    </div>
                  </li>
                  <li className="flex items-center gap-x-10 border-b pb-4">
                    <div className="flex items-center gap-x-2  w-40">
                    ...
                    <div className="flex items-center gap-x-2">
                      <span>{yazilimData && yazilimData.KursSuresi}</span>
                    </div>
                  </li>
