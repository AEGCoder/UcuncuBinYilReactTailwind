...
import InsaatAciklama from "../../components/InsaatAciklama";
...
const InsaatState = () => {
  ...
  const [insaatData, setInsaatData] = useState([]);
  ...
  useEffect(() => {
    const getData = async () => {
      try {
        ...
        const InsaatGet = data.find(
          (insaat) => insaat.titleParams === titleParams
        );
        setInsaatData(InsaatGet);
      } catch (error) {
        console.log(error);
      }
    };
  ...
  return (
    ...
    <div className="">
      <ul className="container  mx-auto flex items-center  sm:gap-x-5 gap-x-2 sm:text-sm text-xs sm:p-10 p-3  border-b border-gray-400">
        ...
        <li>
          <a href="">{insaatData && insaatData.title}</a>
        </li>
      </ul>
                ...
                <ul className="flex flex-col gap-y-7 font-extralight text-sm">
                  <li className="flex items-center gap-x-10 border-b pb-4">
                    ...
                    <div className="flex items-center gap-x-2">
                      <span>{insaatData && insaatData.DersSaati}</span>
                    </div>
                  </li>
                  <li className="flex items-center gap-x-10 border-b pb-4">
                    <div className="flex items-center gap-x-2  w-40">
                    ...
                    <div className="flex items-center gap-x-2">
                      <span>{insaatData && insaatData.KursSuresi}</span>
                    </div>
                  </li>
